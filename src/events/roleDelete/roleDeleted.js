...
module.exports = (client, role) => {
    ...
    function removeRole() {
        ...
        .then(() => logging.globalInfo(__filename, `Successfully removed a role that got removed from discord. roleId: ${roleId}`))
        .catch((error) => logging.error(__filename, `Error removing role that got removed from discord. error: ${error}, roleId: "${roleId}"`));
    };
};